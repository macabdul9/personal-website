...
const positions = [
  {
    company: 'Actively looking for SDE and ML Research Internship opportunities',
    position: '',
    link: '',
    daterange: '',
    points: [],
  },
  {
    ...
    points: [
      'Learned various Classification, Regressive and Generative Models in machine learning and deeep learning',
      'Build multiple projects like caption generator, sentiment analyzer',
    ],
  }, 
  // {
  //   company: 'Enveritas',
